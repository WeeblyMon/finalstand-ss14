...
// All of these events are raised on a mechanism entity when added/removed to a body in different ways.

/// <summary>
/// Raised on an organ when it is added to a body part.
/// </summary>
[ByRefEvent]
public readonly record struct OrganAddedEvent(EntityUid Part, EntityUid Body); // Shitmed - added body

/// <summary>
/// Raised on an organ when it is added to a body part within a body.
/// </summary>
[ByRefEvent]
public readonly record struct OrganAddedToBodyEvent(EntityUid Body, EntityUid Part);

/// <summary>
/// Raised on an organ when it is removed from a body part.
/// </summary>
[ByRefEvent]
public readonly record struct OrganRemovedEvent(EntityUid OldPart, EntityUid? OldBody); // Shitmed - added body

/// <summary>
/// Raised on an organ when it is removed from a body part within a body.
/// </summary>
[ByRefEvent]
