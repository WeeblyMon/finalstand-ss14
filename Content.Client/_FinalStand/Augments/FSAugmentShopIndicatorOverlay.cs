...
public sealed class FSAugmentShopIndicatorOverlay : Overlay
{
    ...
    public FSAugmentShopIndicatorOverlay()
    {
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        var query = _entMan.EntityQueryEnumerator<FSAugmentShopComponent, TransformComponent>();
