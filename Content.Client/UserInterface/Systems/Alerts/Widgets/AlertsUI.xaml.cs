...
public sealed partial class AlertsUI : UIWidget
{
    ...
    public AlertsUI()
    {
        ...
        AlertPanel.PanelOverride = FSHudStyle.ModulePanel();
    }

    // FINALSTAND: an empty bordered box in the corner reads as a broken element, so the panel only
    // exists while it holds something.
    private void UpdatePanelVisibility()
    {
        AlertPanel.Visible = AlertContainer.ChildCount > 0;
    }
