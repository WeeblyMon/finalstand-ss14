...
public sealed partial class RecipeControl : Control
{
    ...
    private static readonly StyleBoxFlat HighlightStyle = new()
    {
        BackgroundColor = Color.Transparent,
        BorderColor = Color.FromHex("#22DD55"),
    ...
    public RecipeControl(LatheSystem latheSystem, LatheRecipePrototype recipe, Func<string> tooltipTextSupplier, bool canProduce, Control displayControl)
    {
        ...
        HighlightPanel.PanelOverride = NormalStyle;
        SetRecipe(recipe);
    ...
    {
        HighlightPanel.PanelOverride = highlighted ? HighlightStyle : NormalStyle;
    }
