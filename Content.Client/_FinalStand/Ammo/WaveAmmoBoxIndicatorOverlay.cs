...
public sealed partial class WaveAmmoBoxIndicatorOverlay : Overlay
{
    ...
    public WaveAmmoBoxIndicatorOverlay()
    {
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        _font    ??= new VectorFont(_resources.GetResource<FontResource>(
            new ResPath("/Fonts/NotoSans/NotoSans-Bold.ttf")), 7);
        ...
        var query = _entMan.EntityQueryEnumerator<WaveAmmoBoxTagComponent, TransformComponent>();
        while (query.MoveNext(out _, out _, out var xform))
        {
            ...
            var labelOrigin = new Vector2(screenPos.X - labelDims.X / 2f, screenPos.Y - 50f + bob);
