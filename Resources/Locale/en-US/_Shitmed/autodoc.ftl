...
# FINALSTAND: Goob shipped these with Chinese alongside the English for aesthetic
# flavor. The default UI font has no CJK glyphs so they rendered as "??" in-game.
# Stripped to English-only.
