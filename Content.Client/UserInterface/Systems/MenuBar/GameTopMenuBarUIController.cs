using Content.Client._FinalStand.Leaderboard;
...
public sealed partial class GameTopMenuBarUIController : UIController
{
    ...
    [Dependency] private FSLeaderboardUIController _leaderboard = default!;
