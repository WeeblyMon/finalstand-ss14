// One job row in the lobby Ready Manifest: icon, name, readied-on-High count (yellow when nobody has it).
...
namespace Content.Client._FinalStand.ReadyManifest.UI;
...
public sealed partial class ReadyManifestEntry : GridContainer
{
    ...
    public ReadyManifestEntry(JobPrototype job, int jobCount, IPrototypeManager prototypeManager, SpriteSystem spriteSystem)
    {
        RobustXamlLoader.Load(this);
