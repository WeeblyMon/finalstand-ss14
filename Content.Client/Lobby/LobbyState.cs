using Content.Client._FinalStand.ReadyManifest;
...
namespace Content.Client.Lobby
{
    public sealed partial class LobbyState : Robust.Client.State.State
    {
        ...
        private ReadyManifestSystem _readyManifest = default!; // FINALSTAND
        ...
        protected override void Startup()
        {
            ...
            _readyManifest = _entityManager.System<ReadyManifestSystem>(); // FINALSTAND
            ...
            Lobby.ManifestButton.OnPressed += OnManifestPressed; // FINALSTAND
        ...
        // FINALSTAND: pre-round Ready Manifest.
        ...
        private void UpdateLobbyUi()
        {
            if (_gameTicker.IsGameStarted)
            {
                ...
                Lobby!.ManifestButton.Visible = false; // FINALSTAND
            }
            else
            {
                Lobby!.StartTime.Text = string.Empty;
                ...
                Lobby!.ManifestButton.Visible = true; // FINALSTAND
            }
