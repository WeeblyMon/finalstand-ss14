...
public sealed class ThermalRegulatorSystem : EntitySystem
{
    ...
    private void ProcessThermalRegulation(Entity<ThermalRegulatorComponent, TemperatureComponent?> ent)
    {
        ...
        _tempSys.ChangeHeat(ent, totalMetabolismTempChange, ignoreHeatResistance: true);
        ...
        if (ent.Comp2.CurrentTemperature > ent.Comp1.NormalBodyTemperature)
        {
            ...
            _tempSys.ChangeHeat(ent, -Math.Min(targetHeat, ent.Comp1.SweatHeatRegulation), ignoreHeatResistance: true);
        }
        else
        {
            ...
            _tempSys.ChangeHeat(ent, Math.Min(targetHeat, ent.Comp1.ShiveringHeatRegulation), ignoreHeatResistance: true);
        }
    }
}
