...
public sealed partial class FSSetBaitTargetOperator : HTNOperator
{
    ...
    {
        if (!blackboard.TryGetValue<EntityUid>(FSAIBlackboardKeys.BaitTarget, out var target, _entManager)
