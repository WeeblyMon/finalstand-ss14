...
public sealed partial class WeaponShopWindow
{
    ...
    private static string UpgradeTypeToStatLabel(WeaponUpgradeType type) => type switch
    {
        ...
        WeaponUpgradeType.SentryAmmo         => "Magazine",
        WeaponUpgradeType.SentryFireRate     => "Fire Rate",
        WeaponUpgradeType.SentryDamage       => "Damage",
        WeaponUpgradeType.SentryRange        => "Range",
        WeaponUpgradeType.ChargeSpeed        => "Charge Speed",
        WeaponUpgradeType.BounceCount        => "Bounces",
        WeaponUpgradeType.BounceRetention    => "Bounce Power",
        WeaponUpgradeType.ChargePierce       => "Pierce",
        WeaponUpgradeType.BounceRefund       => "Refund",
        WeaponUpgradeType.BounceCrit         => "Cascade",
        WeaponUpgradeType.FractureRounds     => "Fracture",
        WeaponUpgradeType.DeployableRegen    => "Regen",
        WeaponUpgradeType.LandmineDamage     => "Damage",
        WeaponUpgradeType.LandmineDetonations => "Detonations",
        WeaponUpgradeType.LandmineHighExplosive => "High Explosive",
